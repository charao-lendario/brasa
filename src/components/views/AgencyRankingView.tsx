...
import { AgencyRankingChart } from '../charts/AgencyRankingChart';
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="text-xs text-gray-400">
          {ranking.length} imobiliaria{ranking.length !== 1 ? 's' : ''} | {totalContracts} contratos | {formatCurrency(totalValue)}
        </div>
      </div>

      <AgencyRankingChart data={ranking} />
